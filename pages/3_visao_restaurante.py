    ...
    """
        ...
        Parâmetros:
            Input:
                ...
                -op: Tipo de operação que preciso ser calculado
...
def distance(df1, fig):
    if fig == False:
        # criação de uma nova coluna no dataframe com a distancia em km entre o restaurante e o local de entrega
        cols = ['Delivery_location_latitude', 'Delivery_location_longitude','Restaurant_latitude', 'Restaurant_longitude', ]

        # utilização do haversine que faz o calculo entre os dois pontos
...
#============================================================
st.header('Marketplace - Visão Restaurantes', divider='red')
